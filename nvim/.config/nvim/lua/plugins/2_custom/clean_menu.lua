return {
  {
    ...
    opts = function(_, opts)
      ...
      table.insert(opts.spec, {
        ...
        -- { "<leader>sa", hidden = true }, -- Danh sách Autocmd
        ...
        -- 📁 File & Buffer
        -- { "<leader> ", hidden = true }, -- Tìm file (Gốc dự án)
        ...
        -- { "<leader>fc", hidden = true }, -- Tìm file cấu hình (Neovim)
        ...
        -- 🔍 Tìm kiếm & Grep
        -- { "<leader>s"", hidden = true }, -- Danh sách Clipboard (Registers)
        ...
        -- { "<leader>sl", hidden = true }, -- Danh sách vị trí (Location List)
        ...
        -- { "<leader>sna", hidden = true }, -- Tất cả tin nhắn Noice
